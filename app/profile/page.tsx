            ...
            <div className="mb-6">
              <div className="bg-[#F0C4C9]/30 rounded-xl p-4 border border-[#BA435F]">
                ...
                <p className="text-[#BA435F] text-sm mb-4">
                  Invite friends to join Love, Simulated and earn SMIRROR for
                  ...
                  <div className="space-y-3">
                    <div className="bg-white/80 rounded-lg p-3 border border-[#BA435F]">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-[#BA435F] font-bold">$4.99</span>
                      </div>
                    </div>
                    <div className="bg-white/80 rounded-lg p-3 border border-[#BA435F]">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-[#BA435F] font-bold">$9.99</span>
                      </div>
                    </div>
                    <div className="bg-white/80 rounded-lg p-3 border border-[#BA435F]">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-[#BA435F] font-bold">$19.99</span>
                      </div>
                    </div>
                  </div>
                </div>
