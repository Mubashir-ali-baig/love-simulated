...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-8 py-[30px] pb-[30px]">
      {/* Mobile Phone Frame */}
            ...
            >
              ...
              <div className="px-4 mb-8">
                <div className="bg-[#F0C4C9]/30 border border-[#BA435F] rounded-xl px-3 py-2 w-full max-w-[353px]">
                  <p className="text-[#BA435F] text-sm mb-1">Which couples clicked? Who ghosted who?</p>
                  <p className="text-[#BA435F] text-sm font-semibold">Get the full download.</p>
                </div>
              </div>
                  ...
                  <div className="bg-[#F0C4C9]/60 p-4 my-[-33px] py-[46px] pb-[60px] pt-[25px]">
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        />
                        <span className="text-[#BA435F] font-semibold text-lg">Today's Highlights</span>
                      </div>
                      {highlightsExpanded ? (
                    ...
                    <div className="text-[#BA435F] text-sm leading-relaxed">
                      <p className="mb-3">
                        Day 5: Ava & Noah's chemistry soars, Emma & Jackson bond over cooking disasters, Sophia & Liam
                        hit a rough patch.
                      </p>
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between px-4 mb-3">
                  <h3 className="text-2xl font-bold text-[#BA435F]" style={{ fontFamily: "Georgia, serif" }}>
                    Newest Confessions
                  </h3>
                ...
                >
                  <div className="flex space-x-4 pl-4 pr-4 pb-2">
                    {confessions.map((confession) => (
                      <div key={confession.id} className="flex-shrink-0 text-center">
                        ...
                        <p className="text-[#BA435F] text-xs font-medium">{confession.name}</p>
                      </div>
                    ))}
                  </div>
                </div>
                    ...
                    {["All", "1-on-1", "Group"].map((tab) => (
                      <button
                        ...
                        className={`flex-1 py-2 px-4 rounded-full text-sm font-medium transition-colors ${
                          activeTab === tab ? "bg-[#BA435F] text-white" : "text-[#BA435F] hover:text-[#BA435F]/80"
                        }`}
                      >
                        {tab}
                      </button>
              ...
              <div className="px-4 mb-6">
                <div className="bg-white/90 rounded-xl overflow-hidden shadow-lg border border-[#BA435F]">
                  ...
                  <div className="relative h-48">
                    ...
                    <img src="/image1.png" alt="Beach Sunset Date" className="w-full h-full object-cover" />
                    ...
                    >
                      <div className="flex-shrink-0 w-14 h-14 mr-3 rounded-full overflow-hidden">
                        <img src="/image2.png" alt="Peter and Alisha" className="w-full h-full object-cover" />
                      </div>
                      <div>
                        <h4 className="text-[#BA435F] font-semibold">Peter and Alisha</h4>
                  ...
                  <div className="p-4 bg-[#F0D1D8]">
                    <h3 className="text-[#BA435F] mb-3 mt-9 font-semibold" style={{ fontSize: "18px" }}>
                      Beach Sunset Date
                    </h3>
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <span
                        ...
                        style={{ fontSize: "14px", fontWeight: "normal", fontFamily: "Grift" }}
                      >
                        Peter • Alisha
                      </span>
                    </div>
                    ...
                    <div className="space-y-3 mb-4">
                      <div className="flex items-center justify-between">
                        <span className="text-[#BA435F] " style={{ fontSize: "12px" }}>
                          Trust
                        </span>
                        <div className="w-32 h-2 bg-[#F0C4C9] rounded-full">
                          <div className="bg-[#BA435F] h-2 rounded-full" style={{ width: "85%" }}></div>
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-[#BA435F] " style={{ fontSize: "12px" }}>
                        ...
                        <div className="w-32 h-2 bg-[#F0C4C9] rounded-full">
                          <div className="bg-[#BA435F] h-2 rounded-full" style={{ width: "95%" }}></div>
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-[#BA435F] " style={{ fontSize: "12px" }}>
                        ...
                        <div className="w-32 h-2 bg-[#F0C4C9] rounded-full">
                          <div className="bg-[#BA435F] h-2 rounded-full" style={{ width: "20%" }}></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between mb-4 pb-4 border-b border-[#BA435F]/20">
                      <span className="text-[#BA435F] " style={{ fontSize: "14px" }}>
                        Match Score
                      </span>
                      <span className="text-[#BA435F] text-2xl mr-[50px]" style={{ fontSize: "18px" }}>
                        96%
                      </span>
                    </div>
                    ...
                    >
                      ...
                      <div className="mb-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-[#BA435F] text-lg font-semibold">Social Rating</span>
                          <div className="flex items-center">
                            {[1, 2, 3, 4, 5].map((star) => (
                              <svg key={star} className="w-5 h-5 text-[#BA435F] fill-current" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                              </svg>
                            ))}
                            <span className="ml-2 text-[#BA435F] font-semibold">5.0</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="text-center mb-4">
                        <div className="flex justify-center items-center space-x-2 mb-2">
                          ...
                          <p className="text-[#BA435F] text-xs flex items-center">
                            <img src="/smirror-coin-icon.png" alt="SMIRROR" className="w-4 h-4 mr-1" />
                            Earn SMIRROR
                          </p>
                        </div>
