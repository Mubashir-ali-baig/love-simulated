          ...
          <div className="w-full h-full bg-gradient-to-b from-[#F4D2D7] from-0% via-[#F8E6E9] via-40% via-[#F8E6E9] via-60% to-[#F4D2D7] to-100% rounded-[50px] overflow-hidden relative">
            ...
            <div className="flex items-center justify-between px-8 pt-4 pb-2 text-sm font-semibold text-[#BA435F]">
              ...
              <div className="flex items-center gap-1">
                ...
                <svg className="w-4 h-3 ml-1 font-semibold border-0" viewBox="0 0 16 12" fill="none">
                  <path
            ...
            <div className="px-8 pb-4 h-full overflow-y-auto scrollbar-hide">
              <div className="mb-6 mt-6">
                <h1 className="text-4xl font-light text-[#BA435F] mb-2" style={{ fontFamily: "Georgia, serif" }}>
                  Signup
                </h1>
                <p className="text-[#BA435F] text-base font-light">Create an account to continue!</p>
              </div>

              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1">
                  <Label htmlFor="fullName" className="text-[#BA435F] font-medium text-sm">
                    Full Name
                  </Label>
                  <Input
                    id="fullName"
                ...
                <div className="space-y-1">
                  <Label htmlFor="email" className="text-[#BA435F] font-medium text-sm">
                    Email Address
                  </Label>
                  <Input
                    id="email"
                ...
                <div className="space-y-1">
                  <Label htmlFor="dateOfBirth" className="text-[#BA435F] font-medium text-sm">
                    Date of Birth
                  </Label>
                  <div className="relative">
                    <Input
                ...
                <div className="space-y-1">
                  <Label htmlFor="password" className="text-[#BA435F] font-medium text-sm">
                    Password
                  </Label>
                  <div className="relative">
                    <Input
              ...
              <div className="mt-6">
                <div className="relative flex items-center">
                  ...
                  <span className="flex-shrink mx-4 text-[#BA435F] font-light text-sm">Or Signup with</span>
                  <div className="flex-grow border-t border-[#BA435F]"></div>
                </div>
              ...
              <div className="mt-6 text-center pb-4">
                <p className="text-[#BA435F] text-sm font-light">
                  ...
                  <Link href="/login" className="font-medium text-[#BA435F] hover:text-[#A03854] underline">
                    Login
                  </Link>
                </p>
              </div>
